<div class="w-full flex justify-center items-center flex-col relative">
    ...
    <div class="w-10/12 flex m-5 rounded bg-white justify-between">
        <div class=" flex ">
            <img src="{{$borrowedBook->user->profile_photo_url}}" class="w-16 h-16 rounded-full" alt="">
            <div class="">
                <h1>{{$borrowedBook->user->name}}</h1>
        ...
        <div class="flex justify-center relative items-center flex-col mt-10">
            ...
            <div class="flex flex-col relative mt-5">
                ...
                <div class="flex relative">
                    <img src="/storage/book.png" alt="" class="w-16 h-16">
                ...
                <div class="flex flex-col mt-5">
                    <h1>Date Borrowed: {{$date_borrowed}} </h1>
                    <h1>Due Date : {{$due_date}} </h1>
                </div>
