<div class="w-full relative flex justify-center items-center flex-col">
    ...
    <div class="m-10 w-10/12 rounded-lg bg-white flex relative justify-between items-center">
        <div class="relative flex">
            <img src="{{ $schedule->user->profile_photo_url }}" alt="{{$schedule->user->name}}" class="h-16 rounded-full">
            <div class="">
                <h1 class="mt-5 ml-5">{{$schedule->user->name}}</h1>
        ...
        <div class="m-10 relative flex flex-col justify-center items-center">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex">
                    ...
                    <div class="">
                        <h1 class="mt-4 ml-3" >{{$BookName}}</h1>
                        <p class="ml-3">({{ $BookCategory }})</p>
                        <p class="ml-3">Quantity: {{ $BookQty }}</p>
                ...
                <div class="flex flex-col ml-16">
                    ...
                    <div class="ml-1">
                        <x-label>Date Borrowed:</x-label>
                        <h1>{{$date}}</h1>
                    </div>
                    <div class="ml-1">
                        <x-label>Date Return:</x-label>
