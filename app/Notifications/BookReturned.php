...
class BookReturned extends Notification implements ShouldBroadcast
{
    use Queueable;
    public $user;
    /**
    ...
    public function toDatabase(object $notifiable)
    {
        return [
            ...
            'date_returned' => $this->user['date_returned'],
             'message' => 'You successfully returned Book Id '. $this->user['book_id'] . ', '. $this->user['book_name']. ", " . $this->user['date_returned']
            ];
    }
